...
class FlutterPayStack extends FlutterBaseController {
	 ...
	 * @var string
	 */
	protected $namespace = 'maan-paystack';
	...
	public function __construct() {
		add_action( 'rest_api_init', [ $this, 'register_flutter_paystack_routes' ] );
	}
	...
	public function register_flutter_paystack_routes() {
		register_rest_route(
			...
			[
				[
					'methods'             => 'POST',
					'callback'            => [ $this, 'initialize_transaction' ],
		...
		register_rest_route(
			...
			[
				[
					'methods'             => 'POST',
					'callback'            => [ $this, 'verify_paystack_transaction' ],
					'permission_callback' => function () {
						return parent::checkApiPermission();
					},
				],
