...
class FlutterPayTm extends FlutterBaseController {
	 ...
	 * @var string
	 */
	protected $namespace = 'maan-paytm';
	...
	public function __construct() {
		add_action( 'rest_api_init', [ $this, 'register_flutter_paytm_routes' ] );
	}
	...
	public function register_flutter_paytm_routes() {
		register_rest_route(
			...
			[
				[
					'methods'             => 'POST',
					'callback'            => [ $this, 'generate_txn_token' ],
	...
	public function generate_txn_token( $request ) {
		...
		$params = [
			...
			'cust_id'  => sanitize_text_field( $body['cust_id'] ),
		];
		$payTm  = new WC_paytm();
